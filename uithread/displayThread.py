...
class DisplayThread(QThread):
    ...
    def __init__(self, face_detect=False, fer_detect=False, fer_modelname="MFER", parent=None):
        ...
        self.class_label = ['AN', 'DI', 'FE', 'HA', 'NE', 'SA', 'SU']
        ...
        if self.fer_detect:
            ...
            self.ferDetModel = createFERmodel(self.fer_modelname, weights_dir="./weights/best_checkpoint.ckpt", cuda=self.cuda_available)
