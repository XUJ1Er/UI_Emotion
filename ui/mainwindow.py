...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Single Person FER System")
        self.setGeometry(300, 300, 750, 550)
        self.setObjectName('backgrnd')
        self.setStyleSheet("#backgrnd{border-image:url(./resource/background.jpg);}")
    ...
    def setupMenuBar(self):
        ...
        self.act_exit = QAction("Exit", self, triggered=QApplication.quit, shortcut=QKeySequence("Q"))
    ...
    def setupCentralWidgets(self):
        ...
        self.title = QLabel()
        self.title.setText("<font size=20><b>Multi-scale FER System</b></font>")
        self.title.setAlignment(Qt.AlignCenter)

        # 2) widgets for 2D texture stream
        self.title_2d = QLabel()  # 2D title
        self.title_2d.setText("<font size=5>Camera Stream</font>")
        ...
        self.combo_2d_cam_id.setCurrentIndex(0)
        ...
        self.apply_2d_set_button = QPushButton("Apply Params")
        self.apply_2d_set_button.setStyleSheet("background-color: #F5FFFA")
        ...
        methods_2d_fer = ['None', 'MFER', 'VGG']
        for method in methods_2d_fer:
            self.combo_2d_fer_methods.addItem(method)

        self.combo_2d_fer_methods.setCurrentIndex(1)  # default VGG
        ...
        res_layout.addWidget(name_an, 0, 0, 1, 1)
        res_layout.addWidget(name_di, 1, 0, 1, 1)
        res_layout.addWidget(name_fe, 2, 0, 1, 1)
        res_layout.addWidget(name_ha, 3, 0, 1, 1)
        res_layout.addWidget(name_na, 4, 0, 1, 1)
        res_layout.addWidget(name_sa, 5, 0, 1, 1)
        res_layout.addWidget(name_su, 6, 0, 1, 1)

        res_layout.addWidget(self.progress_an, 0, 2, 1, 9)
        res_layout.addWidget(self.progress_di, 1, 2, 1, 9)
        res_layout.addWidget(self.progress_fe, 2, 2, 1, 9)
        res_layout.addWidget(self.progress_ha, 3, 2, 1, 9)
        res_layout.addWidget(self.progress_na, 4, 2, 1, 9)
        ...
        self.start_button.setStyleSheet("background-color: #F5FFFA")
        self.stop_button = QPushButton("Stop")
        self.stop_button.setStyleSheet("background-color: #F5FFFA")
    ...
    def setProgressBar(self, logits):
        ...
        self.progress_an.setValue(logits[0]*100)
        self.progress_di.setValue(logits[1]*100)
        self.progress_fe.setValue(logits[2]*100)
        self.progress_ha.setValue(logits[3]*100)
        self.progress_na.setValue(logits[4]*100)
    ...
    def dummySlot(self):
        QMessageBox.about(self,
                          "menu",
                          "This is a editor function. Implement it in the future.")
    ...
    def showAboutSlot(self):
        dev_info = "Software for Multi-scale 2D Facial Expression Recognition (FER). \n\nDeveloper: Xu Jie \nEmail: xuujie@126.com " \
                   "\nGuiZhou University"
